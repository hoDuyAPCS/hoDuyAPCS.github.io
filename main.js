...
function scrollToSection3() {
    const element = document.getElementById('Slide3');
    element.scrollIntoView();
}

function scrollToSection4() {
    const element = document.getElementById('Slide4');
    element.scrollIntoView();
}

function scrollToSection5() {
    const element = document.getElementById('Slide5');
    element.scrollIntoView();
}

function scrollToSection6() {
    const element = document.getElementById('Slide6');
    element.scrollIntoView();
}

function scrollToSection7() {
    const element = document.getElementById('Slide7');
    element.scrollIntoView();
}
...
const sectionFive = document.querySelector("#Slide5");
const options ={
  threshold:0.7
};
...
canvas.addEventListener('mousedown', () => {
    ...
    if (count>MAX_COUNT){
        initFramebuffers();
        multipleSplats(parseInt(Math.random() * 20) + 6);
        count = 0;
    }
});
